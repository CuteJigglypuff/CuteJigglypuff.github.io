...
<div class="page-wrap">
  <div class="section-header" style="margin-bottom:36px;">
    ...
    <p style="color:#8a9a6a;font-size:0.95rem;margin-top:12px;">学习之外努力开发的星际航道</p>
  </div>

  <div class="road-card">
    <input type="checkbox" class="road-toggle" id="r1">
    <label class="road-header" for="r1">
      <span class="r-icon"><i class="fas fa-users"></i></span>
      <span class="r-info"><div class="r-title">学生工作</div><div class="r-sub">组织与担当</div></span>
      <span class="r-arrow"><i class="fas fa-chevron-down"></i></span>
    </label>
    <div class="road-body"><p>（在这里记录你的学生工作经历，打开 C:\Users\13416\docs\explore\index.md 即可修改。）</p></div>
  </div>

  <div class="road-card">
    <input type="checkbox" class="road-toggle" id="r2">
    <label class="road-header" for="r2">
      <span class="r-icon"><i class="fas fa-hand-holding-heart"></i></span>
      <span class="r-info"><div class="r-title">志愿服务</div><div class="r-sub">温暖与奉献</div></span>
      <span class="r-arrow"><i class="fas fa-chevron-down"></i></span>
    </label>
    <div class="road-body"><p>（在这里记录你的志愿服务经历。）</p></div>
  </div>

  <div class="road-card">
    <input type="checkbox" class="road-toggle" id="r3">
    <label class="road-header" for="r3">
      <span class="r-icon"><i class="fas fa-earth-asia"></i></span>
      <span class="r-info"><div class="r-title">社会实践</div><div class="r-sub">走入真实世界</div></span>
      <span class="r-arrow"><i class="fas fa-chevron-down"></i></span>
    </label>
    <div class="road-body"><p>（在这里记录你的社会实践经历。）</p></div>
  </div>

  <div class="road-card">
    <input type="checkbox" class="road-toggle" id="r4">
    <label class="road-header" for="r4">
      <span class="r-icon"><i class="fas fa-compass"></i></span>
      <span class="r-info"><div class="r-title">其他航道</div><div class="r-sub">无限可能</div></span>
      <span class="r-arrow"><i class="fas fa-chevron-down"></i></span>
    </label>
    <div class="road-body"><p>（在这里记录其他探索经历。）</p></div>
  </div>
